...
//     const raw = localStorage.getItem(CART_KEY);
//     if (!raw) {
//       hasMergedRef.current = true; // Mark as merged even if nothing to merge
//       return;
//     }
...
//     hasMergedRef.current = true; // Set BEFORE async operation
...
//         hasMergedRef.current = false; // Reset on error to retry
//       });
//   }, [isLoggedIn, createCart, refetch]); // Add refetch to dependencies
...
//           console.log("*******************",variantId, item.quantity);
...
//       value={{
//         effectiveCart,
//         cartCount: effectiveCart.length,
//         addToCart,
//         increaseItem,
//         decreaseItem,
//         removeItem,
